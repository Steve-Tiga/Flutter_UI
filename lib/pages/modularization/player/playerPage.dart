...
import 'package:flutterstudy/pages/modularization/player/full_video_page.dart';
import 'package:flutterstudy/pages/modularization/player/widget/tencent_player_bottom_widget.dart';
import 'package:flutterstudy/pages/modularization/player/widget/tencent_player_gesture_cover.dart';
import 'package:flutterstudy/pages/modularization/player/widget/tencent_player_loading.dart';
...
class WindowVideoPage extends StatefulWidget {
  ...
  WindowVideoPage({this.showBottomWidget = true, this.showClearBtn = true, this.dataSource});
            ...
            children: <Widget>[
              ...
              showCover ? Positioned(
                ...
                child: GestureDetector(
                  behavior: HitTestBehavior.opaque,
                  onTap: () async {
                    TencentPlayerController newController = await Navigator.of(context).push(CupertinoPageRoute(builder: (_) => FullVideoPage(controller: controller), fullscreenDialog: true));
                    setState(() {
